...
def extract_profile_chunks() -> List[Chunk]:
    ...
    facts = [
        ...
        (
            "Strength",
            "My powerlifting PRs are Squat 355 lbs, Bench 200 lbs, and Deadlift 475 lbs. I am a European powerlifting champion and a national champion in Turkey. I am still holding deadlift records in Turkiye since 2020 and in Florida since 2022. These include both junior and open records, and I broke both while I was a junior. Sources: USAPL records database https://usapl.liftingdatabase.com/records-default?priority=0&recordtypeid=120382&categoryid=&weightclassid= and IPF Turkiye records https://ipfturkiye.com/t%C3%BCrkiye-rekorlar%C4%B1.",
        ),
        (
            "Media",
